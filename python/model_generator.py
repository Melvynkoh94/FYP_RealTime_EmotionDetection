...
#the tensor size is 48x48, with '1' as the color channel of depth 1
...
model.add(Dense(num_classes, activation='softmax')) #last layer usually uses SoftMax for classification
#------------------------------
#batch process
...
#Validate using the test set in x_test
#------------------------------
